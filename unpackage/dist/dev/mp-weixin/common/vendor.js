...
function initRuntimeSocketService() {
  const hosts = "172.28.52.11,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_ZdDybo";
  ...
  !function(o2, e2) {
    ...
    function b(o3, e3) {
      ...
      this.loadImage, this.drawReserve = false, this.isMaked = false, Object.defineProperties(this, { data: { get() {
        if ("" === r2 || void 0 === r2)
          throw index.__f__("error", "at node_modules/uqrcodejs/uqrcode.js:34", "[uQRCode]: data must be set!"), new b.Error("data must be set!");
        return r2;
      }, set(o4) {
        r2 = String(o4);
      } }, size: { get: () => t3, set(o4) {
        ...
        if (void 0 === M)
          throw index.__f__("error", "at node_modules/uqrcodejs/uqrcode.js:34", "[uQRCode]: use drawCanvas, you need to set the canvasContext!"), new b.Error("use drawCanvas, you need to set the canvasContext!");
        return M;
      }, set(o4) {
        M = C(o4);
    ...
    return f2.prototype = { get: function(o3) {
      ...
      if (o3 === r2)
        throw index.__f__("error", "at node_modules/uqrcodejs/uqrcode.js:34", "[uQRCode]: foregroundColor and backgroundColor cannot be the same!"), new b.Error("foregroundColor and backgroundColor cannot be the same!");
      a2 && (n3 = function(o4) {
        o4 = o4.toString();
      ...
      if (!e3)
        return index.__f__("error", "at node_modules/uqrcodejs/uqrcode.js:34", "[uQRCode]: please execute the make method first!"), Promise.reject(new b.Error("please execute the make method first!"));
              ...
              case "image":
                if ("backgroundImage" === n4.name) {
                  ...
                  try {
                    ...
                    throw index.__f__("error", "at node_modules/uqrcodejs/uqrcode.js:34", `[uQRCode]: ${n4.mappingName} invalid!`), new b.Error(`${n4.mappingName} invalid!`);
                  }
